#!/usr/bin/env python3
"""
Simple advanced mode test to isolate the issue
"""

import requests
import json

# Simple advanced mode test payload with safe metrics
payload = {
    ...
    "advanced_metrics": {
        "q1": {
            "sales_marketing": 500000,  # Safe override
            "cash_burn": -200000        # Safe override
        },
        "q2": {
            "sales_marketing": 0,       # Test auto-estimation (0 = estimate)
            "ebitda": -300000           # Safe override
        }
    }
}
